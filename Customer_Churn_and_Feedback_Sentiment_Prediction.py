...
le_churn = pickle.load(open("Customer_Churn_and_Feedback_Sentiment_Prediction_Project/le_churn.pkl", "rb"))
dl_model = pickle.load(open("Customer_Churn_and_Feedback_Sentiment_Prediction_Project/dl_model.pkl", "rb"))
lstm_model = pickle.load(open("Customer_Churn_and_Feedback_Sentiment_Prediction_Project/lstm_model.pkl", "rb"))
le_sentiment = pickle.load(open("Customer_Churn_and_Feedback_Sentiment_Prediction_Project/le_sentiment.pkl", "rb"))
tokenizer = pickle.load(open("Customer_Churn_and_Feedback_Sentiment_Prediction_Project/tokenizer.pkl", "rb"))
